...
os.environ["HF_HOME"] = "/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r/hf"
os.environ["HF_DATASETS_CACHE"] = "/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r/hf/datasets"
os.environ["HF_HUB_CACHE"] = "/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r/hf/hub"
os.environ["TMPDIR"] = "/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r/tmp"
pathlib.Path(os.environ["HF_DATASETS_CACHE"]).mkdir(parents=True, exist_ok=True)
pathlib.Path(os.environ["HF_HUB_CACHE"]).mkdir(parents=True, exist_ok=True)
pathlib.Path(os.environ["TMPDIR"]).mkdir(parents=True, exist_ok=True)
...
LOCAL_SRC = Path("/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r")  # your hf download dir (root)
OUT_ROOT  = Path("/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r/IndicVoices_extracted")
SPLITS    = ["train", "test"]
# ======================================
...
def try_resolve_path(basename: str) -> Path | None:
    ...
    roots = [
        LOCAL_SRC,
        Path(os.environ.get("HF_DATASETS_CACHE", "/mnt/data0/Sougata/Dataset/TTS_data/IndicVoices_r")),
    ]
    for root in roots:
